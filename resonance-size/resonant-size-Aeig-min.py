...
for i,d in enumerate(ds):
    ...
    Aeigs_abs.append(Aeig_abs_sorted[:,0])
    ...
    Aeigs_CHIEF_abs.append(Aeig_abs_sorted_CHIEF[:,0])
    ...
    Aeigs.append(Aeig_sorted[:,0].imag.item())
    Aeigs_CHIEF.append(Aeig_sorted_CHIEF[:,0].imag.item())
    
    Aeigs_real.append(Aeig_sorted[:,0].real.item())
    Aeigs_CHIEF_real.append(Aeig_sorted_CHIEF[:,0].real.item())
